...
uint16_t Adelay = 16534;

// previously determined calibration results for antenna delay 1Meter
// #A1 16567
// #A2 16560
// #A3 16535
// #A4 16548
...
const unsigned long resetInterval = 5000; // 5 detik
...
void loop()
{
  ...
  if (millis() - lastConnectionTime > resetInterval) {
    Serial.println("Tidak terhubung dalam 5 detik. Melakukan reset...");
    ESP.restart(); // Lakukan reset pada ESP32
  }
}
